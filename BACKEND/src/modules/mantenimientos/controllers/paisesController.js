...
export const obtenerPaises = async (req, res) => {
  const { idPais } = req.params; // Obtener el ID de la universidad si se proporciona
  ...
  try {
    ...
    const result = await pool
      .request()
      .input("idPais", idPais ? idPais : null) // Pasar el parámetro opcional
      .execute("Eventos.splPaisesObtener"); // Llamar al procedimiento almacenado
