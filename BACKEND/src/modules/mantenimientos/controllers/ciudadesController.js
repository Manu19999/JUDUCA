...
export const obtenerCiudades = async (req, res) => {
  const { idCiudad } = req.params; // Obtener el ID de la universidad si se proporciona
  ...
  try {
    ...
    const result = await pool
      .request()
      .input("idCiudad", idCiudad ? idCiudad : null) // Pasar el parámetro opcional
      .execute("Eventos.splCiudadesObtener"); // Llamar al procedimiento almacenado
