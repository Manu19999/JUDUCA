...
// Controlador para obtener las bitacoras
export const obtenerBitacoras = async (req, res) => {
  const { idBitacora } = req.params; // Obtener el ID del objeto si se proporciona
  ...
  try {
    ...
    const result = await pool
      .request()
      .input("idBitacora", idBitacora ? idBitacora : null) // Pasar el parámetro opcional
      .execute("Logs.splBitacoraObtener"); // Llamar al procedimiento almacenado
